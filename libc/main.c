...
#define __pyx_n_u_hello __pyx_string_tab[3]
#define __pyx_n_u_libc_main __pyx_string_tab[4]
...
__Pyx_RefNannySetupContext("PyInit_main", 0);
  ...
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4libc_4main_1hello, NULL, __pyx_mstate_global->__pyx_n_u_libc_main); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
